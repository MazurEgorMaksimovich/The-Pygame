...
class AlienInvansion:
    ...
    def __init__(self):
        ...
        self.play_button = Button(self, 'Играть', 'start')
        self.easy_button = Button(self, 'Лёгкая сложность', 'easy')
        self.middle_button = Button(self, 'Средняя сложность', 'middle')
        self.heavy_button = Button(self, 'Сложная сложность', 'heavy')
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    self._check_game_complexity(mouse_pos)
    ...
    def _check_game_complexity(self, mouse_pos):
        if self.easy_button.rect.collidepoint(mouse_pos):
            self.settings.choose_game_mode('easy')
        elif self.middle_button.rect.collidepoint(mouse_pos):
            self.settings.choose_game_mode('middle')
        elif self.heavy_button.rect.collidepoint(mouse_pos):
            self.settings.choose_game_mode('heavy')
